...
# 安装方法
<br><b>- Windows系统</b>
<br>   1. 拷贝"<a href="https://raw.githubusercontent.com/WeiLDavid/hosts/yt/yt">yt</a>", "<a href="https://github.com/racaljk/hosts/raw/master/hosts">main</a>(<a href="https://coding.net/u/scaffrey/p/hosts/git/raw/master/hosts">mirror</a>)", "<a href="https://github.com/WeiLDavid/hosts/raw/dm/dm">dm</a>"以及"<a href="https://raw.githubusercontent.com/WeiLDavid/hosts/psd/psd">psd</a>"到"%windir%\system32\driver\etc\"中的"<b>hosts</b>"文件<br>

#### <a href="###">注意: 一定要按照顺序添加, 不要更换顺序(即:yt-main-dm-psd)</a>
